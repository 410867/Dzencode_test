...
const OrdersModalDelete = (props) => {
    ...
    return (
        <div className="block_orders_modal">
            ...
            <div className="block_button">
                <Button className="button_close" onClick={modalCloseOrders}>ОТМЕНИТЬ</Button>
                <Button className="button_delete"><img src={imgRedDelete} alt=""/>УДАЛИТЬ</Button>
            </div>
            <Button className="button_plus_close" onClick={modalCloseOrders}>+</Button>
        </div>
    );
};
